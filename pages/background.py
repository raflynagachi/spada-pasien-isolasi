...
def app():
    ...
    st.markdown("""
    Pada tanggal 16 Juli 2021 data keterisian tempat tidur atau bed occupancy rate (BOR) untuk pasien covid-19 dirumah sakit jakarta masih tinggi. Keterisian tempat tidur isolasi mencapai 90 persen, sedangkan keterisian ruang ICU 94 persen.

    Berdasarkan data dari pemprov DKI Jakarta per Jum’at (16/7/2021), saat ini ada 140 rumah sakit yang menangani pasien covid-19. dari ratusan rumah sakit tersebut kapasitas tempat tidur isolasi sudah terisi 90 persen atau sebanyak 10.394. Kemudian ruang ICU RS Jakarta telah terpakai sebanyak 94 persen atau 1.436.
